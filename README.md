...
одному замеру; сегодня лестница даёт 100 / 95 / 85 / 93 (§22.6). Провал
...
последнее: **ярус 3 пока легче второго**, и ручка здесь щедрость провианта,
а не бой — маг не преследует, и его опасность меряется шагами обхода,
а не ранами.
