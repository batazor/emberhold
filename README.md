...
npm run dev        # http://localhost:5173
                   # ?camp — открыть лагерь сразу, минуя пролог
                   # ?camp=walls — лагерь с готовым кольцом: ворота, башня,
                   #   лестница. Отладочные сцены: кадр смотрят адресом,
                   #   а не проходом игры до него
...
одному замеру; сегодня лестница ярусов даёт 100 / 94 / 88 / 69 (§22.6),
и она монотонна — до 2026-08-21 ярус 2 стоял вдвое тяжелее третьего из-за
одного неверно снятого числа. Уровни 4–6 пересчитаются тем же скриптом,
как только бой перестанет быть главной причиной провалов: это единственное,
что в §22.6 всё ещё не сошлось.
...
| `?camp` | лагерь сразу, минуя пролог |
| `?camp=walls` | лагерь с готовым кольцом: ворота, башня, лестница |
...
- **Провалов** — как часто вылазка не доходит домой. Ориентира у этой цифры
  нет намеренно: соотношение причин «провиант против боя» снято с действия
  вместе с §11.3, потому что провиант перестал быть осью сложности.
  Кто именно добивает, печатает `npm run measure`.
