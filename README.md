...
пока хранятся и показываются, но в бой не входят: бой ведётся целыми ранами.
§11.3 переписан под две шкалы — Атака в очках стойкости врага, Защита через
пробой, — и код догоняет документ по шагам. Прежняя ссылка на «формулы §11.5»
была ошибочной: §11.5 — экономика построек, и она отменена.
