...
assets/
  ...
  kaykit-resources/      набор добычи (CC0), в игру взяты бревно, слитки, соль
...
Нет карт сборов (§19) и ботов-игроков (§4); Лазарет и Плац пока не здания.
...
- **Провалов** — доля причин: провиант против боя. Целевое соотношение
  выводится моделью (§22.6) и пересчитывается вместе с моделью боя; прежние
  65/35 сняты на старом бое и считаются черновыми.
