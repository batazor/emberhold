...
как только сойдётся то, что в §22.6 не сошлось, — а не сошлась **глубина
провала**: гибнут на трети локации, возвращаются с половины, то есть дальше
безопаснее, чем ближе.
