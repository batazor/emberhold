...
одному замеру; сегодня лестница даёт 100 / 96 / 88 / 92 (§22.6). Провал
...
случался у входа. Уровни 4–6 пересчитаются тем же скриптом, когда сойдётся
последнее: **ярус 3 пока не тяжелее второго**, и ручка здесь щедрость
провианта, а не бой.
