...
def head(f, skin, hair, brow=True):
    ...
    f.box('head', hair, (-0.495, 0.495), (0.060, 0.455), (1.470, 1.985), bevel=0.17, seg=2)  # затылок
    for s in (1, -1):
        ...
        if brow:
            f.box('head', hair, (s * 0.095, s * 0.285), (-0.520, -0.468), (1.968, 2.002),
                  bevel=0.014, seg=1)
...
def settler():
    ...
    f.box('head', 'сукно-свет', (-0.520, 0.520), (-0.505, 0.495), (2.010, 2.345),
          taper=(0.88, 0.90), bevel=0.235, seg=3)                                       # чепец, темя
    f.box('head', 'сукно-свет', (-0.520, 0.520), (-0.090, 0.500), (1.430, 2.120),
          bevel=0.200, seg=2)                                                           # чепец, затылок
