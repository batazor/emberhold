...
| `codepen-carnival-wheel/assets/*` — GLB сцены колеса, запечённые текстуры, Lottie-заставка. Лицензия автором не объявлена — **в бандл игры не едет**, лежит референсом; для игры модель пересобрать свою | там же, `assets.codepen.io/262181/` | не объявлена | Jared Stanley |
