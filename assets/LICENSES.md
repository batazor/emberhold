...
| `dobo-ui/*.png` — 7 картинок интерфейса из демо-версии: рамка листа, кнопка, корыто полосы, две ячейки слота и две производные `*_ember.png`, перекрашенные в палитру проекта; берёт их `src/style.css` девятидольной нарезкой | [dobo-ui.itch.io/fantasy-rpg-ui-pack](https://dobo-ui.itch.io/fantasy-rpg-ui-pack), тариф DEMO (бесплатный) | своя: личные и коммерческие проекты — да; изменение — да; перепродажа/раздача, крипто/NFT, обучение ИИ — нет | dobo_ui |
