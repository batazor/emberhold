...
const PACKS: readonly Pack[] =
  [FOREST, DUNGEON, SKELETONS, ADVENTURERS, RESOURCES, CASTLE, GRAVEYARD, WEAPONS, BUILDER, FOLK, CAMP];
...
/**
 * Геометрия принятых моделей набора ${pack.title} (${pack.own === true ? 'свои модели' : 'CC0'}, см. assets/LICENSES.md),
