...
const FOLK: Pack = {
  ...
  ramps: [
    ...
    { id: 'gold', title: 'латунь', slots: ['латунь'], hue: [35, 65], sat: [0.55, 1] },
    { id: 'moss', title: 'зелень', slots: ['мох'], hue: [65, 200], sat: [0.25, 1] },
  ...
  pose: { file: '../kaykit-animations/gltf/Rig_Medium_General.glb', clip: 'Idle_A', at: 0 },
  rigged: true,
  categoryOf: (name) => (name === 'Merchant' ? 'Торговец' : 'Поселенец'),
  /**
   * Обе модели и есть весь набор: рисовать «на всякий случай» здесь нечего,
   * а каждая стоит килобайтов у всех игроков ровно так же, как чужая.
   */
  adopted: ['Settler', 'Merchant'],
