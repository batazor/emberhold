...
const STATE = {
  ...
  'сидит': { loop: true },
  'встаёт': { loop: false },
  // Рутина жильцов лагеря: труд у кромки — петля, а не одиночный замах,
  // потому что у него нет цели, по которой стучать (§17.3), — и речь,
  // которой жилец сопровождает пузырь реплики (§23.5).
  'рубка': { loop: true },
  'разговор': { loop: true },
