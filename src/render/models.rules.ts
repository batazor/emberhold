 ...
 * за вечер». Готовому набору вторая половина не относится вовсе, а первая
 * треугольниками не измеряется — её решает силуэт. Цена готовой модели одна
 * и она другая: килобайты в бандле у всех игроков. Поэтому у принятого
 * набора свой потолок и своя единица (§6.1.3).
 *
 * Противника в списке нет: все трое — модели набора (§15), и рисовать
 * их руками некому. Строка §6.1 остаётся в силе на случай, когда враг снова
 * появится свой, — но проверять её сейчас не на ком.
 */
