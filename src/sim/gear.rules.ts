...
describe('Мастерская', () => {
  ...
  test('§14 — предмет не может быть лучше своей Мастерской', () => {
    const camp = createCamp();
    camp.levels = { hq: 2, kitchen: 1, storage: 1, forge: 1, infirmary: 0, yard: 0, archery: 0, barracks: 0, watchtower: 0, archive: 0 };
  ...
  test('§14 — Мастерская улучшает, а не рандомит', () => {
    ...
    for (const camp of [a, b]) {
      camp.levels = { hq: 3, kitchen: 1, storage: 1, forge: 3, infirmary: 0, yard: 0, archery: 0, barracks: 0, watchtower: 0, archive: 0 };
      camp.resources = { stone: 0, wood: 0, iron: 999, crystal: 999, food: 0 };
      craftGear(camp, 'ring');
      craftGear(camp, 'ring');
    }
...
describe('Снаряжение в вылазке', () => {
  ...
  test('снаряжение переживает круг save → load', () => {
    ...
    wipe();
    const camp = createCamp();
    camp.levels = { hq: 3, kitchen: 1, storage: 1, forge: 2, infirmary: 0, yard: 0, archery: 0, barracks: 0, watchtower: 0, archive: 0 };
    camp.resources = { stone: 0, wood: 0, iron: 999, crystal: 999, food: 0 };
