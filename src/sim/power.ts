/**
 * Сила лагеря (§29) — одно число, которым лагеря сравниваются между собой.
 *
 ...
 * `power.rules.ts` сверяет вывод с `RAIDS_PER_LEVEL`, и расхождение больше
 ...
 *
 * Это единственная выдумка §29, и другой у неё быть не может: за потолком
...
export interface Standing {
  /** Кто: имя фракции или имя своего клана, если он заведён (§29). */
  readonly who: string;
