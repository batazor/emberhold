...
const POOLS: Record<TalkMood, readonly string[]> = {
  ...
  // §13.7 — добытчику пищи своих присказок не написано: он говорит общими.
  // Пул из одних `idle-` честнее выдуманных строк про охоту — их бы пришлось
  // сочинять под лор, которого нет (§0.1).
  кормим: group('idle-'),
