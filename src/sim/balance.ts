 ...
 *
 * Обоснование пережило смену шкалы, хотя числа в нём поменялись: прежде
 * это было «у героя три раны, встреча стоит примерно одну, пятый противник
 * делает провал нормой». На шкале hp то же самое считается в очках —
 * у героя двадцать, встреча стоит от трёх до шести, и пятый выводит ярус
 * за собственную гарантию модели `survivable`.
 */
