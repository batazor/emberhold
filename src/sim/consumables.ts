 ...
 *
 * Цены подняты после первого прогона: на 4–6 солях экран возврата предлагал
 * покупку в 85–90% возвратов, то есть превращался в торговый автомат, от
 * которого предостерегает §21.3. Правило оттуда — «примерно полторы вылазки
 * своей валюты»; при замеренных четырёх-пяти солях за вылазку это 6–8.
 */
