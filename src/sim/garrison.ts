 ...
 * Лесника (§6.1.6.3) нет и подавно: он живёт не в замке, а у леса за стеной,
 * и во дворе ему нечего делать.
 */
export const DWELLER_LOOKS: readonly DwellerLook[] = ['поселенец'];

/**
 * Все внешности разом. Нужен ровно одному месту — чтению сохранения
 * (`save.ts`): жилец восстанавливается, если его внешность игре известна,
 * а «известна» это весь список, а не тот его кусок, из которого набирают
 * гуляющих. Пока в лагерь приходили одни поселенцы, разницы между двумя
 * списками не было видно, и проверка стояла по `DWELLER_LOOKS` — с первым
 * же лесником она стёрла бы его из сейва молча.
 */
export const DWELLER_LOOK_KINDS: readonly DwellerLook[] =
  ['поселенец', 'поселенка', 'торговец', 'кузнец', 'охотник', 'лесник'];
