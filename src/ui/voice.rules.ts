...
const SIZES: Readonly<Record<string, number>> = { подсказка: 11, отказ: 50, событие: 53, заметка: 2, диалог: 26, хроника: 7 };
...
const CENSUS: Readonly<Record<string, Record<Person, number>>> = {
  ...
  событие: { вы: 6, ты: 0, я: 0, никто: 47 },
