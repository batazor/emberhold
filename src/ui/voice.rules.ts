...
const SIZES: Readonly<Record<string, number>> = { подсказка: 11, отказ: 51, событие: 55, заметка: 2, диалог: 29, хроника: 7 };
...
const CENSUS: Readonly<Record<string, Record<Person, number>>> = {
  ...
  // о случившемся и ничего не просит.
  событие: { вы: 6, ты: 0, я: 0, никто: 49 },
