...
const CENSUS: Readonly<Record<string, Record<Person, number>>> = {
  ...
  //
  // Пять новых «никто» — сундуки и кладовая (§13.6): прибавка пролога,
  // отказ места, стража замка, скелеты засады и полная кладовая у прилавка.
  // Все — о мире, как положено событию.
