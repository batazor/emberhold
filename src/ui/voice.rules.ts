...
const SIZES: Readonly<Record<string, number>> = { подсказка: 11, отказ: 44, событие: 43, заметка: 2, диалог: 26, хроника: 7 };
...
const CENSUS: Readonly<Record<string, Record<Person, number>>> = {
  ...
  // один, потому что отказ говорит о мире, а не об игроке.
  отказ: { вы: 0, ты: 0, я: 0, никто: 44 },
  ...
  // безличный отказ «Палатка: здесь не встанет».
  событие: { вы: 5, ты: 0, я: 0, никто: 38 },
