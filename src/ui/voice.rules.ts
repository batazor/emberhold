...
const SIZES: Readonly<Record<string, number>> = { подсказка: 11, отказ: 46, событие: 48, заметка: 2, диалог: 25, хроника: 7 };
...
const CENSUS: Readonly<Record<string, Record<Person, number>>> = {
  ...
  // стража замка и скелеты засады. Все — о мире, как положено событию.
  событие: { вы: 6, ты: 0, я: 0, никто: 42 },
